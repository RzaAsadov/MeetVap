...
class AppDelegate: ExpoAppDelegate {
  ...
  public override func application(
    ...
    CallNative.noteIncomingCallUrlOpened(url)
    ...
    return expoHandled || linkingHandled
  }
  ...
  public override func application(
    ...
    CallNativeOrientationLock.shared.supportedInterfaceOrientations
  }
}
